 ...
 *
 *  @discussion App id can be retrieved from the Zingle web portal
 *
 ...
 *
 *  @discussion Auth code can be retrieved from the Zingle API
 *
 *  This value may only be set once, and must be set at init time.
 */
 ...
 *
 *  @discussion When set to YES, Zingle will swizzle the following methods of your UIApplicationDelegate in order to automatically handle push notification receiving and registering, as well as user notification handling.
 *
 ...
 *
 *  If set to NO, Zingle will not perform swizzling. It is up to the app to handle Zingle push notifications by doing the following:
 *
 *  1. When a new push token is received in -application:didRegisterForRemoteNotificationsWithDeviceToken:, you must call Zingle +setPushToken.
 *  2. In your -application:didReceiveRemoteNotification: or -application:didReceiveRemoteNotification:fetchCompletionHandler: callback, you must call Zingle +handlePushNotification: with the passed userInfo dictionary.
 *  3. In your -application:handleActionWithIdentifier:forRemoteNotification:withResponseInfo:completionHandler: callback, you must call Zingle +handleUserNotificationActionWithIdentifier:withResponseInfo:completionHandler: with the correct parameters.
 *
 ...
 *
 *  @discussion For more information, see the +userNotificationCenterDelegate method of the Zingle class.
 *
 *  If set to NO, the application must forward calls from its own UNUserNotificationCenterDelegate to Zingle to ensure proper handling of notifications on iOS 10.
 *
 *  The default value is YES.
 *
 *  @see Zingle
 ...
 *
 *  If set to NO, the application must make sure to register the Zingle user notification category settings. For more information, see the +userNotificationCategories method of the Zingle class.
 *
 *  The default value is YES.
 *
 *  @see Zingle
