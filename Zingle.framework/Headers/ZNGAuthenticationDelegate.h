...
typedef void (^ZNGAuthenticationCompletionBlock)(NSString *jwt);
 ...
 */
@protocol ZNGAuthenticationDelegate <NSObject>
 ...
 */
- (void)onInvalidToken:(NSError *) error handler:(ZNGAuthenticationCompletionBlock)completionHandler;
